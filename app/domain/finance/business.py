...
from app.domain.finance.schema import PayloadFinanceMonthPersistSchema


def merge_months_by_month(
    months: list[PayloadFinanceMonthPersistSchema],
) -> list[PayloadFinanceMonthPersistSchema]:
    merged_months: dict[int, PayloadFinanceMonthPersistSchema] = {}
    for month in months:
